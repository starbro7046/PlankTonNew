...
class PoseActivity :
    ...
    private val MIN_CON: Int = 5;
    //minimun accurate frame continued constantly
    ...
    private val stateCallback = object : CameraDevice.StateCallback() {
        ...
        override fun onOpened(cameraDevice: CameraDevice) {
            ...
            this@PoseActivity.cameraDevice = cameraDevice
        ...
        override fun onDisconnected(cameraDevice: CameraDevice) {
            cameraOpenCloseLock.release()
            cameraDevice.close()
            this@PoseActivity.cameraDevice = null
        }

        override fun onError(cameraDevice: CameraDevice, error: Int) {
            onDisconnected(cameraDevice)
            this@PoseActivity.activity?.finish()
        }
    }
    ...
    ): View? = inflater.inflate(R.layout.activity_pose, container, false)
    ...
    private fun processImage(bitmap: Bitmap) {
        ...
        Log.d("pppppppppppp",atan(2f).toString());
        Log.d("pppppppppp",atan2(2f,1f).toString());
        if (poseCode==0) {
    ...
    private fun getAngle(bodyCode1: Int,bodyCode2: Int,person: Person): Double
    {
        return atan2(ratio*(person.keyPoints[bodyCode2].position.y-person.keyPoints[bodyCode1].position.y),ratio*(person.keyPoints[bodyCode2].position.x-person.keyPoints[bodyCode1].position.x))*180/PI;
    }
